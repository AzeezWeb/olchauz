...
import ProductCustomerReviews from "../ProductCostomerReviews";
...
function Product() {
  ...
  const element =  cartItems.filter((item) => item.id === product.id)
      ...
      <div className="product">
        ...
        <div className="product-btns">
          ...
          <div className="product-control__btns">
            <div>
              <BiBarChart /> <p>Taqqoslashga qo'shish</p>
            </div>
            <div>
              <MdFavoriteBorder /> <p> Sevimlilarga qo'shish</p>
            </div>
            <div>
              <HiArrowUturnRight />
              <p>Ulashish</p>
        ...
        <div className="product-details">
          <div className="product-details__box">
            <div className="product-img">
              ...
              <div className="product-des">
                ...
                <a href="#des"> Barcha hususiyatlarini ko'rish</a>
              </div>
            </div>
            <div className="product-details__price">
              ...
              <div>
                <div>
                  <b className="insales-store">
                    Insales Store <CiMedal />
                  </b>
                ...
                <div>
                  <p>
                    ...
                    Manzilga qarab 2 soatdan 2 ish kunigacha yetkazib beriladi
                  </p>
                </div>
                <div>
                  <h2> {product.price} so'm</h2>
                  {element.length !== 0
                    ? <ToCartBtn2 quantity={element[0]}/>
                    : <button className="product-details__cart-btn min" onClick={() => addToCartHandler(product)}>
                    <AiOutlineInbox /> <span>Savatchaga qo'shish</span>
                  </button>
                  }
                </div>
              </div>
          ...
          <div className="product-details__widget">
            <div className="product-details__widget-info">
              <h1 className="product-details__widget-price">
                {product.price} so'm
              </h1>
              <div className="product-details__dilevry">
                ...
                <div className="product-details__dilevry-info">
                  Sotib olayotgandan yetkazib berish vaqitini moslashingiz
                  mumkin
                </div>
              </div>
              ...
              <hr />
             {element.length === 0 
                ?  <button className="product-details__cart-btn" onClick={() => addToCartHandler(product)} >
                      <AiOutlineInbox /> <span>Savatchaga qo'shish</span>
                    </button>
                :  <Link to='/cart'>
                      <button className="product-details__cart-btn">
                        <AiOutlineInbox /> <span>Savatchaga o'tish</span>
                      </button>
                    </Link>
            ...
            <div className="product-details__widget-credit">
              <p>Bo'lib to'lash</p>
              <h2 className="product-details__widget-credit-price">
                {(product.price / 12).toFixed()} so'm / 12 oy
              </h2>
              <div className="logo">
                <svg
                  width="102"
